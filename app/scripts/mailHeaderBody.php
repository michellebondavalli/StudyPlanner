          ...
          <table role='presentation' width='600' cellspacing='0' cellpadding='0' border='0' bgcolor='#ffffff' style='margin: 20px auto; border-radius: 8px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);'>
            ...
            <tr>
              <td style='padding: 40px; text-align: center; font-size: 18px; color: #333;'>
                ...
                <br>
                <p>
                  Benvenuto/a <strong>$nome $cognome</strong>!<br>
                  Clicca sul pulsante per verificare la tua email.
                </p>
                <br>
                
                <!-- Pulsante -->
                <a href='https://studyplanner.altervista.org/app/scripts/verificaToken.php?token=$hashToken' style='text-decoration: none;'>
                  <table role='presentation' cellspacing='0' cellpadding='0' border='0' align='center'>
                    <tr>
                      <td bgcolor='#98bee2' style='border-radius: 30px;'>
                        <a href='https://studyplanner.altervista.org/app/scripts/verificaToken.php?token=$hashToken' style='display: inline-block; padding: 15px 45px; font-size: 16px; color: #ffffff; background-color: #98bee2; border-radius: 30px; text-decoration: none; font-weight: bold;'>
                          Verifica
                        </a>
                      </td>
                    </tr>
